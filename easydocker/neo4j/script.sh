...
# # 접속 잘 되는지 확인
# docker exec -it ec2-user-mmt-neo4j-1 cypher-shell -u neo4j -p 비번
# # 잘 되면 나가기
# :exit
# # 데이터 초기화
# docker exec -it ec2-user-mmt-neo4j-1 cypher-shell -u neo4j -p 비번 -f /var/lib/neo4j/import/init.cypher
